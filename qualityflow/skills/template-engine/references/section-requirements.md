...
- **Epic Tracking** -- Epic key + Parent key if exists (e.g., `Epic: PROJ-xxxxx, Parent: PROJ-xxx`)
...
Standard tools (as defined in the project's test framework configuration) should NOT be listed.
